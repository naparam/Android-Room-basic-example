...
import com.example.appiness.architecture_component.viewModels.AddEntityViewModel;
...
public class AddActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private AddEntityViewModel addEntityViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addEntityViewModel = ViewModelProviders.of(this).get(AddEntityViewModel.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (itemEditText.getText() == null || nameEditText.getText() == null || date == null)
                    ...
                    addEntityViewModel.addBorrow(new EntityModel(
